...
describe 'Chopper' do
  ...
  it 'chop de 3 y [0,7,3,4,4] deberia ser 2' do
    expect(chopper.chop(3,[0,7,3,4,4])).to eq 2
  end

  it 'chop de 3 y [0,7,2,4,4,3] deberia ser 5' do
    expect(chopper.chop(3,[0,7,2,4,4,3])).to eq 5
  end

  it 'chop de 3 y [0,7,2,4,4,3,4,3] deberia ser 5' do
    expect(chopper.chop(3,[0,7,2,4,4,3,4,3])).to eq 5
  end
